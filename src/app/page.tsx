...
export default function Home() {
  ...
  useEffect(() => {
    // Solo redirige a la búsqueda cuando entramos la primera vez
  ...
  return (
    <main className="p-8">
      <div className="w-full max-w-7xl bg-white rounded-2xl shadow-lg p-10 min-w-fit">
        <div className="grid [grid-template-columns:3fr_1fr] gap-2">
          ...
          <div className="flex flex-col gap-6">
          <h1 className="text-2xl font-bold mb-4 ml-10">Balance Detail</h1>
